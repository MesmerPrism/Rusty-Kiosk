...
Version `0.6.2` is the first published bundle. The earlier `v0.6.0` and
`v0.6.1` tags are retained as pre-publication workflow-failure checkpoints and
have no release assets.
